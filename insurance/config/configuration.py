...
class Configuration:
    ...
    def __init__(self,config_file_path=CONFIG_FILE_PATH,time_stamp=CURRENT_TIME_STAMP) -> None:
        try:
    ...
    def get_data_transformation_config(self)->DataTransformationConfig:
        try:
            ...
            preprocessed_obj_file_path=os.path.join(data_transformation_artifact_dir,
                                                    ...
                                                    data_transformation_config_info[DATA_TRANSFORMATION_PREPROCESSED_OBJECT_FILE_KEY]
                                                    )
